...
class Bot:
    ...
    def run(self):
        self.game.ready("BogdanDm (backup v3)")
    ...
    def loop(self):
        ...
        ships_pos = [ship.position for player in self.game.players.values() for ship in player.get_ships()]
            ...
            if ship.halite_amount >= constants.MAX_HALITE * self.ship_fill_k:
                ...
                for radius in (8,):  # *range(1, 5)
                    ...
                    for coord in surrounding:
                        ...
                        surrounding[coord] /= (gmap.calculate_distance(ship.position, coord) + 1) ** 1.5
